...
class Game:
    ...
    def __init__(self):
        ...
        pyxel.load("./assets/Sprites.pyxres",image = True,tilemap = True)
    ...
    def __change_level(self):
        ...
        if self.__enemies_killed >= 10 and self.__constants.level == 0:
        ...
        elif self.__enemies_killed >= 10 and self.__constants.level == 1:
        ...
        elif self.__enemies_killed >= 10 and self.__constants.level == 2:
